...
export default async function HistoryPage() {
  ...
  if (!userId) {
    return (
      <div className="min-h-screen from-white to-gray-50 dark:from-black dark:to-gray-950">
  ...
  return (
    <div className="min-h-screen from-white to-gray-50 dark:from-black dark:to-gray-950">
      <div className="container mx-auto py-12 px-6 lg:px-8 space-y-12">
        ...
        {!isPro && (
          <Card className="border-2 border-blue-600 dark:border-blue-500   from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 transition-all hover:shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="inline-flex size-12 items-center justify-center rounded-lg   from-blue-600 to-purple-600 text-white">
                  <Crown className="h-6 w-6" />
                </div>
                <div>
                  <CardTitle className="text-3xl   from-blue-600 to-purple-600 bg-clip-text text-transparent">
                    Upgrade to Pro
                  </CardTitle>
              ...
              <div className="space-y-4 flex-1">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <div className="inline-flex size-6 items-center justify-center rounded-md   from-blue-600 to-purple-600 text-white shrink-0 mt-0.5">
